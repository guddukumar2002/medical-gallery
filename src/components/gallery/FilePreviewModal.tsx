      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-2 pt-3 border-t border-slate-700">
          <a
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 px-2 py-2.5 sm:px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs font-semibold rounded-xl hover:opacity-90 transition-opacity shadow-lg shadow-blue-500/20 text-center"
          >
          ...
          <a
            href={file.fileUrl}
            download
            className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 px-2 py-2.5 sm:px-4 bg-slate-700 text-slate-200 text-xs font-semibold rounded-xl hover:bg-slate-600 transition-colors border border-slate-600 text-center"
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={onClose}
            className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 px-2 py-2.5 sm:px-4 text-xs font-semibold text-slate-400 bg-slate-800 border border-slate-700 rounded-xl hover:bg-slate-700 hover:text-white transition-colors text-center"
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
