...
export default function Topbar({ title, subtitle }: TopbarProps) {
  ...
  return (
   <header
  className="fixed top-0 left-0 right-0 lg:left-64 h-20 border-b border-slate-800 px-4 sm:px-6 py-4 flex items-center justify-between z-20 backdrop-blur-xl"
