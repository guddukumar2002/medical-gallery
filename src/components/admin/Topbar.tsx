...
export default function Topbar({ title, subtitle }: TopbarProps) {
  ...
  return (
   <header
  className="fixed top-0 left-0 right-0 lg:left-64 h-20  border-b border-slate-800 px-6 py-4 flex items-center justify-between z-20 backdrop-blur-xl"
  style={{ background: "rgba(15,23,42,0.85)" }}
>
      <div className="pt-2 pl-2">
        <h1 className="text-xl font-bold text-white lg:ml-0 ml-10  max-md:text-lg">{title}</h1>
